...
builder.Services.AddKeyedSingleton<ISolution, Day9>(9);
builder.Services.AddKeyedSingleton<ISolution, Day10>(10);
builder.Services.AddKeyedSingleton<ISolution, Day11>(11);
